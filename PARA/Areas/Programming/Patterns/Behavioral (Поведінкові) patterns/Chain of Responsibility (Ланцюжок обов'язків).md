...
![[Pasted image 20240207211844.png | center]]
...
![[Pasted image 20240207212042.png | center]]
<center><i>Запит проходить ряд перевірок перед доступом до системи замовлень</i></center>
...
![[Pasted image 20240207212147.png | center]]
<center><i>З часом код перевірок стає все більш заплутаним.</i></center>
...
![[Pasted image 20240207212419.png | center]]
<center><i>Обробники слідують в ланцюжку один за іншим</i></center>
...
![[Pasted image 20240207212547.png | center]]
<center><i>Ланцюжок можна виділити навіть із дерева об’єктів</i></center>
...
---
## 🏎️ Аналогія з життя
![[Pasted image 20240208124339.png | center]]
<center><i>Приклад спілкування з підтримкою</i></center>
...
![[Pasted image 20240208124847.png | center]]
...
![[Pasted image 20240208125647.png | center]]
<center><i>Графічний інтерфейс побудований за допомогою компонувальника, де кожен елемент має посилання на свій елемент-контейнер. Ланцюжок можна вибудувати, пройшовши по всіх контейнерах, у які вкладено елемент</i></center>
...
![[Pasted image 20240210195813.png | center]]
<center><i>Приклад виклику контекстної допомоги у ланцюжку об’єктів UI</i></center>
...
2. Є сенс у тому, щоб створити абстрактний базовий клас обробників, аби не дублювати реалізацію методу отримання наступного обробника в усіх конкретних обробниках.
    
    Додайте до базового обробника поле для збереження посилання на наступний елемент ланцюжка. Встановлюйте початкове значення цього поля через конструктор. Це зробить об’єкти обробників незмінюваними. Але якщо програма передбачає динамічну перебудову ланцюжків, можете додати ще й сетер для поля.
...
1. Клієнт може збирати ланцюжок обробників самостійно, спираючись на свою бізнес-логіку, або отримувати вже готові ланцюжки ззовні. В останньому випадку ланцюжки збираються фабричними об’єктами, спираючись на конфігурацію програми або параметри оточення.
...
- Реалізує _принцип єдиного обов’язку_.
