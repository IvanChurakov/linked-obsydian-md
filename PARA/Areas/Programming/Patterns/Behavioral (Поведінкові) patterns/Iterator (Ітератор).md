...
- Ви можете обходити дерево [Компонувальника](https://refactoring.guru/uk/design-patterns/composite), використовуючи [Ітератор](https://refactoring.guru/uk/design-patterns/iterator).
- [Фабричний метод](https://refactoring.guru/uk/design-patterns/factory-method) можна використовувати разом з [Ітератором](https://refactoring.guru/uk/design-patterns/iterator), щоб підкласи колекцій могли створювати необхідні їм ітератори.
- [Знімок](https://refactoring.guru/uk/design-patterns/memento) можна використовувати разом з [Ітератором](https://refactoring.guru/uk/design-patterns/iterator), щоб зберегти поточний стан обходу структури даних та повернутися до нього в майбутньому, якщо буде потрібно.
- [Відвідувач](https://refactoring.guru/uk/design-patterns/visitor) можна використовувати спільно з [Ітератором](https://refactoring.guru/uk/design-patterns/iterator). _Ітератор_ відповідатиме за обхід структури даних, а _Відвідувач_ — за виконання дій над кожним її компонентом.